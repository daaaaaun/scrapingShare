...
class NcafeWriteAtt:
    ...
    def writeAttendCheck(self):
        ...
        self.driver.find_element_by_name('id').send_keys('sixtynineee')
        self.driver.find_element_by_name('pw').send_keys('dlekdms!1711')
        self.driver.find_element_by_xpath('//*[@id="frmNIDLogin"]/fieldset/input').click()
        self.driver.implicitly_wait(30) #서버에서 response될때까지 30초간 기다리겠다. --> 얘때문에 안됨...
        self.driver.get('https://cafe.naver.com/MemoList.nhn?search.clubid=23036289&search.menuid=11') #버스커버스커 카페
        self.driver.implicitly_wait(30)
        # 네이버 카페는 iframe으로 이루어져 있어서 글작성을 원하는 블럭에 접근이 어렵다. 따라서 frame으로 전환이 필요하다.
        self.driver.switch_to_frame('cafe_main')
        self.driver.find_element_by_id('contents').send_keys('반갑습니다.')
