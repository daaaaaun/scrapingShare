...
class NcafeWriteAtt:
    ...
    def __init__(self): # intializing해서 한번만 초기화 할 것이므로 self선언
        ...
        self.driver = webdriver.Chrome(chrome_options=chrome_options, executable_path="c:/Python/workspace/section3/webdriver/chrome/chromedriver")
    ...
    def writeAttendCheck(self):
        ...
        self.driver.implicitly_wait(30) #서버에서 respnse될때까지 30초간 기다리겠다.
